                        ...
                        <div className="event__card">
                            <div className="event__card--content">
                                <div className="event__card--content-area">
                                    ...
                                    <div className="parag">The faculty at MountFort is excellent and rich in their subject knowledge. They freely interact with us and willingly clarify our doubts. They also guide us with career options.</div>
                                </div>
                        ...
                        <div className="event__card">
                            <div className="event__card--content">
                                <div className="event__card--content-area">
                                    ...
                                    <div className="parag">MountFort has a stress free and a friendly environment. I’m really glad I decided to join MountFort because it’s helped me understand the subjects rather than just memorizing them and it has also helped me grow as an individual.</div>
                                </div>
                                <img className="poly" src={polyImg} alt="image" />
                            </div>
                            {/* <div className="author-sec">
                        ...
                        <div className="event__card">
                            <div className="event__card--content">
                                <div className="event__card--content-area">
                                    ...
                                    <div className="parag">Over all it’s a great place to seek good education and it encourages culture and a friendly rapport between the teachers and the students. It has physical development activities like games. A place to have fun and learn. In case I get a chance to recommend a best school at Aushapur, I will definitely recommended MountFort School.</div>
                                </div>
                                <img className="poly" src={polyImg} alt="image" />
                            </div>
                            {/* <div className="author-sec">
                        ...
                        <div className="event__card">
                            <div className="event__card--content">
                                <div className="event__card--content-area">
                                    ...
                                    <div className="parag"> Emphasis on cultural activities and events that promote heritage and student bonding.</div>
                                </div>
                                <img className="poly" src={polyImg} alt="image" />
                            </div>
                            {/* <div className="author-sec">
