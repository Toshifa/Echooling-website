                            ...
                            <div className="container">
                                <div className="slider-content">
                                    <div className="content-part">
                                        <span className="slider-pretitle wow animate__fadeInUp" data-wow-duration="1s">Great Quality Social life</span>
                                        ...
                                        <div className="slider-btn wow animate__fadeInUp" data-wow-duration="1.2s">
                                            <Link to="/admission" className="react-btn-border">Admissions</Link>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="container">
                                <div className="slider-content">
                                    <div className="content-part">
                                        ...
                                        <h2 className="slider-title wow animate__fadeInUp" data-wow-duration="1s">
                                            Discover the world of<br /> possible school.
                                        </h2>
                                        <div className="slider-btn wow animate__fadeInUp" data-wow-duration="1.2s">
