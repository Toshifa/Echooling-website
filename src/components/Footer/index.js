...
import Logo from '../../assets/images/logos/logoF.png';
        ...
        <>
            <footer id="react-footer" className={footerClass ? footerClass : 'react-footer home-main'}>
                            ...
                            <div className="col-lg-3 md-mb-30">
                                <div className="footer-widget footer-widget-1">
                                    <div className="footer-logo white">
                                        ...
                                        <span className="school-name">MountFort School</span>

                                    </div>
                                    <h5 className="footer-subtitle">MountFort is a place for nurturing conversations and understanding.<br/> <br/> We believe that all the people are innately valuable as they were created, and it is that identity, that energy, that charges ours students.</h5>
                                    <ul className="footer-address">
                                        <li><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="feather feather-phone"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg><a href="tel:+(402)76244183"> 9515147442 / 9603999926 </a></li>
                ...
                <div className="copyright">  
                    <div className="container">                  
                        <div className="react-copy-left">© 2024 <Link to="/">MountFort.</Link> All Rights Reserved</div>
